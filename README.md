This repository contains the code for a Streamlit-based chatbot. It utilizes a conversational AI model named Mistral to understand and respond to user queries.
